...
public class DataSourceInfoTest {
    ...
    public void testSerialize() {
        ...
        md.setColumnDescription(2,"Team Name");
        ...
        SimpleProps p = dsi.serializeToProps(null,null);
        System.out.println("dsi = " + dsi + "\np = " + p);
        
        DataSourceInfo dsi2 = new DataSourceInfo();
        dsi2.deserializeFromProps(p, null);
        
        assertTrue(dsi.equals(dsi2));
    }
