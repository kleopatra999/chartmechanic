...
public class FileUtil {
    ...
    public static int deepDelete(File dir) {
        ...
        if (!del) {
            throw new RuntimeException("cannot delete file/directory "
                    + dir.getAbsolutePath());
        }
        return deleted;
    }
    ...
    public static void main(String[] a) throws Exception {
        File root = new File("/home/dave/my_fs");
        File sub = new File(root, "some/other/junk.jpg");
        System.out.println("relative: '" + relativePath(root,sub) + "'");
    }
    */
