...
public class CreateImageTest {
    ...
    //  generate a CSV string of random walk values from 100 days ago
    ...
    public void testMovingAverageTooLargeWindow() throws Exception {
        ...
        SeriesDescriptor sd;
        double maDays = 10000; // what happens when the moving average window is too big
    ...
    public void testRandomWalk() throws Exception {
        ...
        long t = System.currentTimeMillis();
        //ChartResult cr = fac.create(cb,templateChartProps,null,cache.prepChartResult(cb,null,user));
        ChartDiskResult cr = createChart(cb);
        System.err.println("RANDOM WALK OVERTICK chart create took: " + (System.currentTimeMillis() - t) + " msecs");
        
//        t = System.currentTimeMillis();
//        //cr = fac.create(cb,null,null,cache.prepChartResult(cb,null,user));
//        cr = createChart(cb);
//        System.err.println("RANDOM WALK chart with no template props create took: " + (System.currentTimeMillis() - t) + " msecs");
    ...
    public void testOHLC() throws Exception {
        ...
        
        {
            ...
            //cr = fac.create(cb,templateChartProps,null,cache.prepChartResult(cb,null,user));
            cr = createChart(cb);
            cache.putChart(cr,cb,null);
    ...
    public void testTimeBubble() throws Exception {
        ...
        ChartInfo ci = new ChartInfo();
        ci.setPlotType(PlotType.PLOT_TIME);
        //ci.setName("Tiny Pink Bubbles...(Don Ho!)");
...
//            avg.setColumn1(3);
//            avg.setSource(ds.getId());
//            avg.setAggregate(StreamStats.AGGREGATE_AVG);
...
//            avg.setAggregate(StreamStats.AGGREGATE_AVG);
    ...
    public void testHistogramGaussian() throws Exception {
        ...
        //SeriesInfo[] series = new SeriesInfo[1];
        ...
        //ChartResult cr = fac.create(cb,templateChartProps,noParams,cache.prepChartResult(cb,noParams,user));
        ChartDiskResult cr = createChart(cb);
    ...
    // different renderers can make things appear in the legend more than once
    @Test
    public void testLegendConsistency() throws Exception {
        ...
        
        {
            ...
            // same as the default - should only appear once
            s.setRenderer("Line");
            ...
            min.setRange(true);
            min.setAxisIndex(0);
//            min.setSource(ds.getId());
//            min.setColumn1(2);
//            min.setAggregate(StreamStats.AGGREGATE_MIN);
            ...
            max.setRange(true);
            max.setAxisIndex(0);
//            max.setSource(ds.getId());
//            max.setColumn1(2);
//            max.setAggregate(StreamStats.AGGREGATE_MAX);
        ...
        //ci.setName("Should Be 3 Legend Items");
    ...
    public void testRecessionRange() throws Exception {
        ...
        cb.setChartInfo(ci);
        ci.setPlotType(PlotType.PLOT_TIME);
        //ci.setName("US Recession Interval Marker");
    ...
    public void testCategory1() throws Exception {
        ...
        //ci.setName("Multi-series, Multi-axis category");
    ...
    public void testStackedBarColors() throws Exception {
        ...
        cb.setChartInfo(ci);
        ci.setPlotType(PlotType.PLOT_CATEGORY);
        //ci.setName("2008 Olympic Medal Totals (as of 8/9/08)");
        ...
        // color RGBS from http://en.wikipedia.org/wiki/List_of_colors
    ...
    public void testBrokerage() throws Exception {
        ...
        ci.setRenderType("Bar");
        {
            ds = h2Info("BROKERAGE");
            ds.setDataScript(
                    "SELECT date_trunc('year',d) as DT,SUM(amount) FROM BROKERAGE"
    ...
    public void testStackedTimeSeries() throws Exception {
        ...
        cb.setChartInfo(ci);
        ci.setPlotType(PlotType.PLOT_TIME);
        //ci.setName("90-day STACKED timeseries from 2008-01-01 (with a Standard Line also)");
    ...
    public void testOnlyTimestamp() throws Exception {
        ...
        cb.setChartInfo(ci);
        ci.setPlotType(PlotType.PLOT_TIME);
        //ci.setName("90-day timeseries from 2008-01-01");
    ...
    public void testBadSeries() throws Exception {
        ...
        try {
            ...
            // generate error stack trace inline w/ image
            cr.setShowErrorImage(true);
            //cr = fac.create(cb,templateChartProps,null,cr);
            cr = createChart(cb,null,cr);
            
            cache.putChart(cr, cb, null);
            this.renameChart(cr, "bad_series");
            p("created chart: " + cr);
            //Assert.fail("create chart should have failed because of bad data source name in series");
        } catch (Exception e) {
    ...
    public void testMathFunctions() throws Exception {
        ...
        ci.setId("math"); // this ID is used to name the image map
        ...
        //props.put("plot.domainGridlinesVisible", "false");
        ...
        props.put(ChartInfo.getRangeAxisPropertyPrefix(2) + "."
                + ChartConstants.CM_PROP_PREFIX + "axisLocation",
                "TOP_OR_LEFT"
                );
        // log axis for #1

        props.put(ChartInfo.getRangeAxisPropertyPrefix(1) + "."
                + ChartConstants.CM_PROP_PREFIX + "axisType",
                "log"
                );
    ...
    private static void setRangeProps(SimpleProps props, int index,
            String label, Double lower, Double upper, String color) {
    ...
    // make a random set of data that's
    // year,val1, val2
...
//        return DSFactory.createInlineDS(sb.toString());
    }
    ...
    public static void produceIndexOfCharts() throws IOException {
        ...
        for (String n : l) {
            ...
            if (n.endsWith(".png")) {
                out.write("<b>" + n + "</b><br/>");
            } else if (n.endsWith(".imap")) {
                out.write(readContents(new File(cacheRoot, n)));
            }
            */
        }
        out.write("</p>\n");
        out.write("</body></html>");
        out.close();
        //p("please read index file " + f.getAbsolutePath() + " to see if images are kosher");
    }
    ...
    private void renameChart(ChartDiskResult dr, String newbase) {
        ...
        //p("chart '" + newbase + "' geometry: " + cr.describeGeometry());
        //String imap = p.substring(0, p.length() - 3) + "imap";
        //p("renaming imap '" + imap + "'");
        File f = new File(p);
...
//    private static JdbcDataSource h2DataSource(String tableName) {
//        try {
////          JdbcDataSource jds = new JdbcDataSource("org.h2.Driver","jdbc:h2:mem:charttest;DB_CLOSE_DELAY=-1","sa","");
//            h2dbprops.put(DataSourceInfo.TABLE_NAME, tableName);
//            return new JdbcDataSource(h2dbprops);
//        } catch (Exception e) {
//            p("failed to create jds beacuse of " + e);
//            return null;                            
//        }
//
//    }
